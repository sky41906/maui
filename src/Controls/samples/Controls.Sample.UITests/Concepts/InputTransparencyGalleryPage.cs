...
namespace Maui.Controls.Sample
{
	internal class InputTransparencyGalleryPage : CoreGalleryBasePage
	{
		...
		{
			// Button
			AddDefaultButtonOverlay();
			AddButtonOverlay();
			AddTransButtonOverlay();

			// Image
			AddImageOverlayInputBlocked();
			AddTransImageOverlay();
			AddImageBackOverlayInputBlocked();
			AddTransImageBackOverlay();

			// Layout
			AddLayoutOverlayInputBlocked();
			AddTransLayoutOverlay();
		...
		void AddDefaultButtonOverlay() =>
			Add(Test.InputTransparency.DefaultButtonOverlay, new Button { Text = "Click Me!" })
		...
		void AddButtonOverlay() =>
			Add(Test.InputTransparency.ButtonOverlay, new Button { Text = "Click Me!", InputTransparent = false })
				.With(t => t.View.Clicked += (s, e) => t.ReportSuccessEvent());
		...
		void AddImageOverlayInputBlocked() =>
			Add(Test.InputTransparency.ImageOverlayInputBlocked, () =>
			{
		...
		void AddImageBackOverlayInputBlocked() =>
			Add(Test.InputTransparency.ImageBackOverlayInputBlocked, () =>
			{
				var button = new Button { Text = "Click Me!" };
				var grid = new Grid
				{
		...
		void AddLayoutOverlayInputBlocked() =>
			Add(Test.InputTransparency.LayoutOverlayInputBlocked, () =>
			{
				var button = new Button { Text = "Click Me!" };
				var grid = new Grid
				{
